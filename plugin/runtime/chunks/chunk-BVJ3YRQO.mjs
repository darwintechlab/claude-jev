import {
  ...
  validate,
  validateAsync
} from "./chunk-NJQ5FXNU.mjs";
import {
  __export
} from "./chunk-QTEOOZ7M.mjs";
...
var ProgressTokenSchema = union([string(), number2().int()]);
...
var RequestIdSchema = union([string(), number2().int()]);
...
var ElicitResultSchema = ResultSchema.extend({
   ...
   */
  content: preprocess((val) => val === null ? void 0 : val, record(string(), union([string(), number2(), boolean(), array(string())])).optional())
});
